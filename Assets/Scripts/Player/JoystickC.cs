...
public class JoystickC : MonoBehaviour {
	...
	private static  JoystickC[] joysticks;						// A static collection of all joysticks
	...
	void ResetJoystick()
	{
		...
		if ( touchPad ){
			Color newColor = new Color(gui.color.r, gui.color.g, gui.color.b, 0.025F);
			gui.color = newColor;
		}
	}
...
//						fingerDownTime = Time.time;
				...
				{	
					...
					{					
						Rect tmpRect = new Rect(gui.pixelInset);
