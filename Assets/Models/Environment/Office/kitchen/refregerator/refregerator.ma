...
//Name: refregerator.ma
//Last modified: Tue, Nov 26, 2013 03:34:06 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.0411883913170836 5.3402229648310788 -7.246590824674418 ;
	setAttr ".r" -type "double3" 345.26164726334855 143.79999999994385 359.99999999998238 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 9.3348549936386185;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -3.5365760897576592e-007 2.4711251258850098 -2.4249597885273033e-008 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.14325380979033753 100.34157609673419 0.25455046567940098 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 26.320401543065124;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.15758395985104 2.6917683390626173 -0.5789644030393637 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 12.512962519239634;
...
createNode transform -n "pCube15";
	setAttr ".rp" -type "double3" 2.384185791015625e-007 2.4711251258850098 0 ;
	setAttr ".sp" -type "double3" 2.384185791015625e-007 2.4711251258850098 0 ;
createNode mesh -n "pCubeShape15" -p "pCube15";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.72926770015627806 0.50000095367431641 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 24 ".uvst[0].uvsp[0:23]" -type "float2" 0.63690048 0.29308724
		 0.82150435 0.29302907 0.82163483 0.70691311 0.63703102 0.70697135 0.75913793 0.87876439
		 0.4574981 0.0036510229 0.011443464 0.0036950707 0.69635069 0.87878424 0.69284427
		 0.12123802 0.63684934 0.13029081 0.82145298 0.13023263 0.75744396 0.12121767 0.14741668
		 0.9963848 0.302398 0.99642742 0.15524761 0.0036101341 0.30588201 0.0035813451 0.45747557
		 0.99636543 0.98443145 0.70686191 0.63708228 0.86976779 0.011363502 0.99628448 0.98430103
		 0.29297781 0.47410399 0.29313856 0.82168609 0.86970961 0.4742344 0.70702267;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 12 ".vt[0:11]"  1.10219097 4.94225025 1.025933504 -1.10219049 4.94225025 1.025933504
		 1.10219097 0 1.025933504 -1.10219049 0 1.025933504 1.10219097 0 -0.91804385 -1.10219049 0 -0.91804385
		 1.10219097 4.94225025 -0.91804385 -1.10219049 4.94225025 -0.91804385 -0.35526037 0 -1.025933504
		 -0.337883 4.94225025 -1.025933504 0.39449263 0 -1.025933504 0.43351221 4.94225025 -1.025933504;
	setAttr -s 22 ".ed[0:21]"  0 1 0 2 3 0 4 10 0 6 11 0 0 2 0 1 3 0 2 4 0
		 3 5 0 4 6 0 5 7 0 6 0 0 7 1 0 8 5 0 9 7 0 8 9 1 10 8 0 11 9 0 10 11 1 10 2 0 8 3 0
		 11 0 0 9 1 0;
...
createNode transform -n "pCube16";
	setAttr ".t" -type "double3" -0.0091911187312408993 2.7661226426718875 -1.0270353449036653 ;
createNode mesh -n "pCubeShape16" -p "pCube16";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".pt[0:7]" -type "float3"  0.032523956 0 0 -0.032523956 
		0 0 0.032523956 0 0 -0.032523956 0 0 0.032523956 0 0 -0.032523956 0 0 0.032523956 
		0 0 -0.032523956 0 0;
createNode transform -n "pCube17";
	setAttr ".t" -type "double3" 0.23316625123087592 2.7661226426718875 -1.0270353449036653 ;
createNode mesh -n "pCubeShape17" -p "pCube17";
	...
	setAttr -s 8 ".pt[0:7]" -type "float3"  0.032523956 0 0 -0.032523956 
		0 0 0.032523956 0 0 -0.032523956 0 0 0.032523956 0 0 -0.032523956 0 0 0.032523956 
		0 0 -0.032523956 0 0;
	setAttr -s 8 ".vt[0:7]"  -0.071482703 -1.092787385 0.053905647 0.071482703 -1.092787385 0.053905647
		 -0.071482703 1.092787385 0.053905647 0.071482703 1.092787385 0.053905647 -0.071482703 1.092787385 -0.053905647
		 0.071482703 1.092787385 -0.053905647 -0.071482703 -1.092787385 -0.053905647 0.071482703 -1.092787385 -0.053905647;
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "C:/My Files/IAC/BabyBoom3d/Office/refregerator/refregerator.jpg";
createNode place2dTexture -n "place2dTexture1";
createNode polyCube -n "polyCube1";
	setAttr ".w" 0.14296540294324833;
	setAttr ".h" 2.1855747080139776;
	setAttr ".d" 0.10781129349986251;
	setAttr ".cuv" 4;
createNode blinn -n "hands";
	setAttr ".c" -type "float3" 0.94871444 0.94871444 0.94871444 ;
