...
//Last modified: Tue, Nov 19, 2013 12:01:10 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.59387121144258503 6.2806204600266566 -3.2871067641268539 ;
	setAttr ".r" -type "double3" -119.73835273004558 0.59999999866083187 359.99999999973909 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 7.0712863133400568;
...
createNode transform -n "polySurface20";
	setAttr ".t" -type "double3" 0 0.022592619957014587 0 ;
...
createNode transform -n "polySurface23";
	setAttr ".t" -type "double3" 0.021069300002683811 0 0 ;
...
createNode transform -n "polySurface25";
	setAttr ".t" -type "double3" 0 -0.017278532748986275 0 ;
...
connectAttr "polySurfaceShape23.iog" "blinn4SG.dsm" -na;
