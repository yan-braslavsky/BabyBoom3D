...
//Name: poster.ma
//Last modified: Wed, Nov 27, 2013 01:59:16 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.7741321204713509 1.1113900097766505 1.7728827066745998 ;
	setAttr ".r" -type "double3" 716.06164726949589 -666.99999999953104 359.99999999990729 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 2.6805003041915962;
...
createNode mesh -n "posterShape" -p "poster";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.37250342835461492 0.74865480114227878 ;
...
createNode mesh -n "polySurfaceShape1" -p "poster";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".pt[0:7]" -type "float3"  -0.14151827 -2.6309798 0.066028237 
		-0.14151827 -2.6309798 0.066028237 -0.14151827 -2.6309798 0.066028237 -0.14151827 
		-2.6309798 0.066028237 -0.14151827 -2.6309798 0.066028237 -0.14151827 -2.6309798 
		0.066028237 -0.14151827 -2.6309798 0.066028237 -0.14151827 -2.6309798 0.066028237;
	setAttr -s 8 ".vt[0:7]"  0.11575009 2.67309117 1.14823437 0.16728644 2.67309117 1.14823437
		 0.11575009 4.17902756 1.14823437 0.16728644 4.17902756 1.14823437 0.11575009 4.17902756 -1.28029084
		 0.16728644 4.17902756 -1.28029084 0.11575009 2.67309117 -1.28029084 0.16728644 2.67309117 -1.28029084;
...
createNode polyPlanarProj -n "polyPlanarProj1";
	...
	setAttr ".ws" yes;
	setAttr ".pc" -type "double3" 0 0.79507958889007568 0 ;
	setAttr ".ro" -type "double3" -90 0 0 ;
	setAttr ".ps" -type "double2" 2.4285252094268799 2.4285252094268799 ;
...
createNode polyTweakUV -n "polyTweakUV1";
	setAttr ".uopa" yes;
	setAttr -s 12 ".uvtk[0:11]" -type "float2" -1.079891205 0 -1.079891205
		 0 0.012758568 -0.35355267 -1.079891205 0 -0.26942837 -0.35355267 -1.079891205 0 -0.26942837
		 -0.17856762 -1.079891205 0 -1.079891205 0 0.012758568 -0.17856762 -1.079891205 0
		 -1.079891205 0;
...
createNode polyTweakUV -n "polyTweakUV2";
	setAttr ".uopa" yes;
	setAttr -s 20 ".uvtk";
	setAttr ".uvtk[0]" -type "float2" 1.1075975 0.77251625 ;
	setAttr ".uvtk[1]" -type "float2" 2.019387 0.81091779 ;
	setAttr ".uvtk[3]" -type "float2" 2.0586202 0.19225548 ;
	setAttr ".uvtk[5]" -type "float2" 0.98716289 -0.17473574 ;
	setAttr ".uvtk[7]" -type "float2" 0.99816561 -0.18908232 ;
	setAttr ".uvtk[8]" -type "float2" 0.96594173 -0.17473575 ;
	setAttr ".uvtk[10]" -type "float2" 1.0373989 -0.80774456 ;
	setAttr ".uvtk[11]" -type "float2" 1.9540341 -0.17473572 ;
	setAttr ".uvtk[12]" -type "float2" 0.98716289 -0.17473575 ;
	setAttr ".uvtk[13]" -type "float2" 0.79719186 0.77251625 ;
	setAttr ".uvtk[14]" -type "float2" 1.9328127 -0.17473574 ;
	setAttr ".uvtk[15]" -type "float2" 1.9981656 0.81091779 ;
	setAttr ".uvtk[16]" -type "float2" 1.0586202 -0.80774456 ;
	setAttr ".uvtk[17]" -type "float2" 0.79719186 -0.27520669 ;
	setAttr ".uvtk[18]" -type "float2" 1.9328127 -0.17473572 ;
	setAttr ".uvtk[19]" -type "float2" 1.1075975 -0.27520669 ;
	setAttr ".uvtk[20]" -type "float2" 1.0193869 -0.18908232 ;
	setAttr ".uvtk[21]" -type "float2" 0.96594173 -0.17473574 ;
	setAttr ".uvtk[22]" -type "float2" 2.0373991 0.19225548 ;
	setAttr ".uvtk[23]" -type "float2" 1.9540341 -0.17473574 ;
createNode file -n "file1";
	setAttr ".ftn" -type "string" "C:/My Files/IAC/BabyBoom3d/Office/posters/poster_1.jpg";
...
connectAttr "posterShape.wm" "polyPlanarProj1.mp";
connectAttr "polyPlanarProj1.out" "polyPlanarProj2.ip";
connectAttr "posterShape.wm" "polyPlanarProj2.mp";
