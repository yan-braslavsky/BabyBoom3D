...
//Name: picture.ma
//Last modified: Thu, Nov 28, 2013 06:27:05 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.6800496200072841 3.9427682358281988 -10.44658612673841 ;
	setAttr ".r" -type "double3" -6.9383527291030509 -2665.4000000003975 359.99999999991837 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 11.587383886513811;
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.9328241299816495 100.38992205502139 0.10656210539594946 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 23.799880785679797;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.47779184383678369 0.34048016342528792 100.18781470753922 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 1.0795630580206432;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1394763999315 0.37118408751263926 -0.20049193866067283 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 9.3526315789473689;
...
createNode transform -n "picture1";
	setAttr ".rp" -type "double3" 0 2.2848773807049785 0 ;
	setAttr ".sp" -type "double3" 0 2.2848773807049785 0 ;
createNode mesh -n "pictureShape1" -p "picture1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.29693691522519339 0.8230549978173296 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 16 ".uvst[0].uvsp[0:15]" -type "float2" 0.98601556 0.04211989
		 0.9858923 0.031213135 0.046218574 0.97006249 0.98601532 0.6071347 0.54765528 0.97006249
		 0.023215175 0.6071372 0.54765528 0.6760475 0.023215175 0.042117268 0.01188302 0.04210937
		 0.046218574 0.6760475 0.023339987 0.61804366 0.99734449 0.60714245 0.023339987 0.031210303
		 0.01188302 0.60714614 0.9858923 0.61804175 0.99734449 0.042112082;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".vt[0:7]"  -0.043981023 0.0087280273 3.88192701 0.043981023 0.0087280273 3.88192701
		 -0.043981023 4.56102657 3.88192701 0.043981023 4.56102657 3.88192701 -0.043981023 4.56102657 -3.88192701
		 0.043981023 4.56102657 -3.88192701 -0.043981023 0.0087280273 -3.88192701 0.043981023 0.0087280273 -3.88192701;
...
createNode lambert -n "picture";
createNode shadingEngine -n "lambert2SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
createNode file -n "file1";
	setAttr ".ftn" -type "string" "C:/My Files/IAC/BabyBoom3d/Office/picture/picture.jpg";
...
connectAttr "file1.oc" "picture.c";
connectAttr "picture.oc" "lambert2SG.ss";
connectAttr "pictureShape1.iog" "lambert2SG.dsm" -na;
connectAttr "lambert2SG.msg" "materialInfo1.sg";
connectAttr "picture.msg" "materialInfo1.m";
